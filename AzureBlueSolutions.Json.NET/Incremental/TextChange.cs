namespace AzureBlueSolutions.Json.NET
{
    ...
    /// If <see cref="NewText"/> is <c>null</c>, the operation is a deletion; if it is an empty string, the slice is removed.
    /// </remarks>
    /// <param name="StartOffset">
    /// The zero-based start offset (inclusive) of the range to replace.
    /// </param>
    /// <param name="EndOffset">
    /// The zero-based end offset (exclusive) of the range to replace. Must be greater than or equal to <paramref name="StartOffset"/>.
    /// </param>
    /// <param name="NewText">
